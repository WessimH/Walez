      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-gray-500">
            Configure les préférences de Salesforce
            Integration Studio.
          </p>
        </div>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-blue-700">
              Ces préférences sont uniquement enregistrées
              dans le navigateur.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-5 p-5">
            <div>
              ...
              <p className="mt-2 text-xs text-gray-500">
                Le thème sombre sera pleinement visible une
                fois les variantes dark ajoutées aux autres
                composants.
              </p>
            </div>
        ...
        <section className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
          ...
          <div className="space-y-5 p-5">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-gray-500">
                Cette valeur pourra être utilisée comme LIMIT
                initial dans le SOQL Builder.
              </p>
            </div>
      ...
      <section className="flex flex-col gap-3 rounded-xl border border-gray-200 bg-white p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Les paramètres seront conservés dans ce
            navigateur.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-red-50 hover:text-red-600"
          >
            <RefreshCw size={16} />
            Reset
          </button>
